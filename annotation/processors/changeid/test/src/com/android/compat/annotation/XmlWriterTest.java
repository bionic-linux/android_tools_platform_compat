...
public class XmlWriterTest {
    ...
    public void testOneChange() {
        XmlWriter writer = new XmlWriter();
        Change c = new Change(123456789L, "change-name", false, null, null, "package");
    ...
    public void testSomeChanges() {
        XmlWriter writer = new XmlWriter();
        Change c = new Change(111L, "change-name1", false, null, "my nice change", "package");
        Change disabled = new Change(222L, "change-name2", true, null, null, "package");
        Change sdkRestricted = new Change(333L, "change-name3", false, 28, "", "package");
        Change both = new Change(444L, "change-name4", true, 29, null, "package");
